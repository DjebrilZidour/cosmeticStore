    ...
    return(
        <section className="flex justify-center items-center w-full my-8">
            <ul className="flex justify-center items-center gap-4 text-xl text-gray  border-b rounded-full shadow-lg">
                <li className="cursor-pointer font-serif border-white p-4 rounded-full hover:bg-red-100"><a href="#home">Home</a></li>
                <li className="cursor-pointer font-serif border-white p-4 rounded-full hover:bg-red-100"><a href="#shop">Shop</a></li>
                <li className="cursor-pointer font-serif border-white p-4 rounded-full hover:bg-red-100"><a href="#about">About</a></li>
